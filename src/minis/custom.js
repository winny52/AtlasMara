        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="md:w-1/2 md:pl-8">
                    ...
                    <p className="text-gray-700 text-lg mb-4">Atlas Mara Logistics  Ltd is an authorized customs clearance company in  Kenya, specializing in streamlining the intricate processes associated with the transportation of shipments.</p>
                    <p className="text-gray-700 text-lg mb-4">Atlas Mara being a customs licensed broker help your goods clear quickly and efficiently by taking advantage of the latest Customs release initiatives and reviewing your product to make sure they comply with specific regulations.</p>
