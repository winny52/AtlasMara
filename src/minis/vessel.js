        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3 md:pl-8">
                    ...
                    <p className="text-gray-700 mb-4">Atlas Mara Logistics provides Vessel Chartering, utilizing our extensive knowledge of ship owners and their fleet capacities by selecting the ideal vessels and terminals, whether it’s a bulk carrier or a heavy-lift, and negotiating the most favorable Terms & Conditions.</p>
