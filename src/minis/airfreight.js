        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="md:w-1/2 pr-4 md:pr-8 mb-4 md:mb-0">
                    ...
                    <p className="text-gray-700 text-lg mb-4">At Atlas Mara Logistics Ltd, we excel in providing top-tier air freight solutions that elevate your business to new heights. Our dedicated team, extensive global network, and unwavering commitment to precision ensure your cargo arrives with speed, security, and efficiency. Trust us for a seamless air freight experience that sets the standard for excellence in global logistics.</p>
