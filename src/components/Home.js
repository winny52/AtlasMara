...
import backgroundImage from '../assets/home.jpg'; // Import the background image
        ...
        <div className="min-h-screen" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
            <div className="bg-hero-pattern bg-cover min-h-screen flex items-center justify-center relative animate-background">
                <div className="container mx-auto px-3 text-center text-white relative z-10 animate-fade-in-up">
                    <h1 className="text-4xl text-black font-bold mb-4">Atlas Mara</h1>
                    <p className="text-gray-900 mb-8">Your Caring Logistics Partner</p>
                    <button className="bg-blue-700 text-white px-8 py-3 rounded-full hover:bg-blue-700 mb-8">
                        Explore More
                    </button>
